...
import {DemoFormSkuMyComponent} from './demo-form-sku-my/demo-form-sku-my.component';
...
export const examples: ExampleDef[] = [
  ...
  {label: 'MySku', name: 'DemoFormMySku', path: 'mysku', component: DemoFormSkuMyComponent},
...
const routes: Routes = [
  ...
  { path: 'mysku', component: DemoFormSkuMyComponent, pathMatch: 'full' },
